...
-(id)initWithlist:(NSArray *)list height:(CGFloat)height{
    ...
    if(self){
        ...
        view = [[UITableView alloc]initWithFrame:CGRectMake(0, ScreenHeight, ScreenWidth,44*([list count] + 1) + 10) style:UITableViewStylePlain];
...
//       NSArray *MenuList = @[Model_6];
        [cell setData:Model_6];
    }
